...
export const LUXURY_ITEMS: LuxuryItem[] = [
  // --- ROYAL HAMPERS ---
  {
    ...
    isFeatured: true,
    customizable: true,
    origin: 'Atelier Signature, Hand-assembled',
  },
  {
  ...
  // --- EMBELLISHMENTS & STATIONERY ---
  {
    ...
    royalHighlights: ['Handmade Amalfi Paper', 'Authentic Wax Stamp', 'Atelier Calligrapher Inscribed'],
...
export const BROCHURES: BrochureItem[] = [
  ...
  {
    id: 'brochure-floral',
    title: 'Floral Atelier: Seasonal Royal Blooms',
    ...
    downloadName: 'Hamper_Queen_Floral_Atelier_2026.pdf',
...
export const PRICING_TIERS_CONFIG: PricingTierDetail[] = [
  {
    ...
    curationHighlights: [
      ...
      '3 to 4 Artisanal Gourmet Delicacies or Floral Accents',
      'Handmade Deckle-Edge Card with Atelier Calligraphy',
  ...
  },
  {
    ...
    curationHighlights: [
      ...
      '5 to 7 Rare Items: 24K Truffles, Amber Candle, Crystal Goblets',
      'Custom Wax Seal Stamped in Imperial Crimson or Gold',
      'Preserved Botanical Sprig & Silk Lining Accents',
      'Dedicated Atelier Concierge Status Updates',
    ],
  ...
  },
  {
    ...
    curationHighlights: [
      ...
      'Direct Atelier Master Florist & Scribe Consultation',
    ],
