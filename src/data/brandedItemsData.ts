...
export const PACKAGING_SIZE_OPTIONS: PackagingSizeOption[] = [
  // --- GIFT BOXES ---
  {
    ...
    slotCount: 2,
    subtitle: 'Our smallest gift box starting at ₹199 (+delivery). Fits 2 treats or chocolates',
    dimensions: '14 × 10 × 6 cm',
    approxPriceRange: '₹199 – ₹299 (+delivery)',
    recommendedFor: 'Pocket Surprise, Token of Appreciation, Return Favors',
    popularBadge: 'Starts ₹199',
  ...
  },
  {
    ...
    approxPriceRange: '₹299 – ₹499 (+delivery)',
